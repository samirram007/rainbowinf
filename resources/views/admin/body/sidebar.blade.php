            ...
            <li class="treeview  {{ $prefix == '/employees' ? 'active' : '' }}">
               <a href=" #">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'monthly.salary.manage' ? 'active' : '' }}"><a href="{{ route('monthly.salary.manage') }}"><i class="ti-more"></i>Employee  Monthly Salary</a></li>
            ...
            <li class="treeview {{ $prefix == '/news' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'news.view' ? 'active' : '' }}">
                        <a href="{{ route('news.view')}}" ><i class="ti-more"></i>News Room</a></li>
            ...
            <li class="treeview {{ $prefix == '/gallery' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'gallery.view' ? 'active' : '' }}">
                        <a href="{{ route('gallery.view')}}" ><i class="ti-more"></i>Gallery</a></li>
                    {{-- <li><a href="{{ route('marksheet.generate.view')}}"><i class="ti-more"></i>MarkSheet Generate</a></li>
                    <li><a href="{{ route('student.result.view')}}"><i class="ti-more"></i>Student Result</a></li> --}}
                </ul>
            </li>
            <li class="treeview {{ $prefix == '/gallery' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'notice.index' ? 'active' : '' }}">
                        <a href="{{ route('notice.index')}}" ><i class="ti-more"></i>Notice</a></li>
                    {{-- <li><a href="{{ route('marksheet.generate.view')}}"><i class="ti-more"></i>MarkSheet Generate</a></li>
                    <li><a href="{{ route('student.result.view')}}"><i class="ti-more"></i>Student Result</a></li> --}}
                </ul>
            </li>
