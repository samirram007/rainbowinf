                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" name="date" class="form-control"
                                                        value={{ $editData[0]->date }} aria-invalid="false">
                                                    @error('date')
                                                    ...
                                                    <tr id="div{{$emp->id}}" class="text-center">
                                                        ...
                                                        <td colspan="3">
                                                            <div class="switch-toggle switch-3 switch-candy d-flex justify-content-between ">
                                                                <div   >
                                                                <input type="radio" name="attent_status{{$key}}" value="Present" id="present{{$key}}" {{ ($emp->attend_status=='Present'?'checked':'')}}  >
                                                                <label for="present{{$key}}">Present</label>
                                                                </div>
                                                                
                                                                <div  >
                                                                <input type="radio" name="attent_status{{$key}}" value="Leave" id="leave{{$key}}" {{ ($emp->attend_status=='Leave'?'checked':'')}}  >
                                                                <label for="leave{{$key}}">Leave</label>
                                                                </div>
                                                                
                                                                <div  >
                                                                <input type="radio" name="attent_status{{$key}}" value="Absent" id="absent{{$key}}" {{ ($emp->attend_status=='Absent'?'checked':'')}} >
