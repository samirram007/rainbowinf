                            ...
                            <div class="col">
                                <form method="POST" action="{{ route('store.news') }}">
                                            ...
                                            <div class="form-group">
                                                 ...
                                                 <div class="controls">
                                                     <input type="datetime-local" name="published_at" class="form-control"
                                                           aria-invalid="false" value="{{ old('published_at')!=null? old('published_at') : Carbon\Carbon::now()->format('Y-m-d')."T".Carbon\Carbon::now()->format('H:i')}}" >
                                                         @error('published_at')
                                                         <span class="text-danger">{{ $message}}</span>
                                                        @enderror
                                                 </div>
                                    ...
                                    <div class="text-xs-right">
                                        <input type="submit" class="btn btn-rounded btn-info text-uppercase " value="Confirm and publish this news">
                                    </div>
                                </form>
                            </div>
                            <!-- /.col -->
