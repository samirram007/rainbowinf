...
<body>
    ...
    {{-- <div class="d-flex justify-content-end px-5 pt-5">
        <a href="{{ route('admin.login') }}" class="btn bg-white fw-bold">Admin Login</a>
    </div> --}}
    <div class="container">
        {{-- <x-jet-validation-errors class="mb-4" /> --}}
        @if (session('status'))
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('login') }}" method="post" class="form-box my-5 px-3">
                        ...
                        <div class="form-input">
                            ...
                            <input type="email" name="email" placeholder="Enter Employee Email Address"
                                tabindex="10" required id="email">
                        </div>
                        <div class="form-input">
                            <span><i class="fa fa-key"></i></span>
                            <input type="password" name="password" id="password" placeholder="Enter Employee Password"
                    ...
                    <div class="d-flex float-end">
                     <a href="{{route('admin.login')}}" class="btn bg-dark text-white">Admin Login</a>
                    </div>
                </div>
            </div>
        </div>
