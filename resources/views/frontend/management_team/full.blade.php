  ...
  $collection = [
          ...
          'Description' => "<p>Mr  Roy  completed his B.E. from Bengal Engineering College in 1987 . He is having more than 34 years of experience handling D&E, Housing & Hotel  Contracts by way of serving different Corporate Companies at various positions. He is Active Member of following professional bodies.</p>
                                  <div style='color: #0de5fb;'>
                                    <ul type='round' style='list-style: circle;'>
                                      <li>The Institute of Engineers</li>
                                      <li>He is Chartered Engineer.</li>
                                    </ul>
                                  </div>
                      </p>
      ...
      [
          'Section' => 'section-m4',
          'HeaderImage' => 'frontend/assets/images/Sandip_Guha_photo.jpg',
          'HeaderName' => 'Mr Sandip Guha',
          'Designation' => 'Vice President – Electrical  Division',
          'Short-Description' => 'Mr. Sandip Guha  completed his B.E. from Bengal Engineering College in 1991 . He is having more than 30 years of experience D&E, Project Management, Planning & Monitoring various Contracts by way of serving different Corporate Companies at various positions.   ',
          'Description' => "<p>Mr Guha  completed his B.E. from Bengal Engineering College in 1991 . He is having more than 30 years of experience D&E,
  			Project Management, Planning & Monitoring various Contracts by way of serving different Corporate Companies at
  			various positions. He is Active Member of following professional bodies.</p>
  			<div style='color: #0de5fb;'>
  				<ul type='round' style='list-style: circle;'>
  				<li>Indian Institute of Plant Engineers.</li>
  					<li>Fellow of “ The Institute of Engineers”.</li>
  					<li>Level D from IPMA.</li>
  			</ul>
  			 </div>",
          'Extra' => "<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>He had very much gracious presence with following professional houses serving various prestigious projects throughout India and Abroad. </strong>
          		<div style='color: white; padding:15px;'>
  					<ul type='round' style='list-style: circle;'>
  						<li>M.N.Dastur & Company Ltd (1991-97)</li>
  						<li>National Hydroelectric Power Corporation Ltd(1997-2007)</li>
  						<li>Larsen & Tubro-Sargent & Lundy Ltd (2007-2013)</li>
  						<li>S.K.Engineering & Construction (2013-2016)</li>
  						<li>Vikram Solar PvtLtd(2016-2017)</li>
  						<li>Rainbow Infrastructure Pvt Ltd (2017 to till date)</li>
  					</ul>
          		</div>
          	</div>
  			<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>He has successfully completed/associate with various prestigious projects like :</strong>
  				<div style='color: white; padding:15px;'>
  				<ul type='round' style='list-style: circle;'>
  					<li>3X30 MW Laktak Power Station, Leimatak,Manipur for NHPC</li>
  					<li>3X20 MW Rangit Hydel Power Station, Rangit,Sikkim for NHPC</li>
  					<li>1,50,000 TPA Sponge Iron Plant with Cogeneration facility of 2x7.5 MW at Dagri,MP for Prakash Industries Ltd</li>
  					<li>1,50,000 TPA Sponge Iron Plant at Champa, MPNova Iron & Steel Ltd</li>
  					<li>TISCO Phase-IV Modernaisation, Jamshedpur for TISCO</li>
  					<li>2X31 MW Combined Cycle Power Plant,Cuddalore for L&T Power</li>
  					<li>2X60 MW – Reinforcement of Wadi Al-Dawaser Power Plant, Wadi for Al Toukhi Company,KSA</li>
  					<li>2X80 MW Simple Cycle Project for Reinforcement of Al Qurayat Power Plant for Hyundai Engineering & Construction Ltd</li>
  					<li>2X600 MW ,Shree Singaji TPP,Stage I, Malwa for Madhya Pradesh Power Generation Corporation Ltd</li>
  					<li>2X600 MW TPP,Anuppur phase I,Anuppur for Lanco Infrastructure/Moser Baer</li>
  					<li>2x250 MW Open Cycle Power Plant,Azzour & Sabiya,Kuwait for Alghanim International</li>
  					<li>Tufanbeyli (150 MW)TPP at Turkey for Enerji SA</li>
  					<li>Wirye Combined Heat & Power Plant (450 MW) at Hanam, South Korea for Wirye Energy Service & Co</li>
  					<li>North American Polypropylene (NAPP) at Redwater Albarta, Cnada for North American Polypropylene ULC</li>
  					<li>Karbala Refinery Project at Karbala,Iraq for HDGSK JV</li>
  					<li>Roof Top Solar Project at Haryana for Denso</li>
  					<li>2x65 MW,NTPC,Rajasthan for NTPC</li>
  					<li>10 MWp Power Plant at Badsid,Rajasthan for Solar Energy Corporation Of India</li>
  					<li>10 MWp Solar project near Madanpalle,Tirupati for TTD Development Authority,AP</li>
  					<li>2X10 MWp Solar Project at Karnataka for Jindal Steel</li>
      ...
      [
          ...
          'Description' => "<p>Mr  Ghosh  completed his B.E. from Bengal Engineering College in 1991  . He is having more than 30 years of experience handling EPC Contracts by way of serving different Corporate Companies at various positions. He was with </p>
        			<div style='color: #0de5fb;'>
  					<ul type='round' style='list-style: circle; '>
  						<li>CIVON CONSTRUCTIONS Pvt LTD (1991-92)</li>
  						<li>ISGEC JOHN THOMPSON(1992-94)</li>
  						<li>NICCO CORPORATION LTD (1994-2004)</li>
  						<li>RAMKY INFRASTRUCTURE LTD (2004-05)</li>
  						<li>RAINBOW INFRASTRUCTURE Pvt LTD(An ISO 9001:2015 Certified Company)</li>
  					</ul>
              	</div> ",
      ...
      [
          'Section' => 'section-m3',
          'Extra' => "<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>Project Executed for the Client`s So Far : </strong>
  							<div style='color: white; padding:15px;'>
  								<ul type='round' style='list-style: circle; '>
  								<li>Indian Oil Corporation Limited, Gujarat Refinery, Baroda, India</li>
  								<li>Indian Oil Corporation Limited, Panipat Refinery, Haryana, India</li>
  								<li>Indian Petrochemical Corporation Limited, Dahej Plant, Bharuch, Gujarat, India</li>
  								<li>Steel Authority India Limited, Bhilai, Chattishgarh, India</li>
  								<li>Neelachal Ispat Nigam Limited, Jajpur, Orissa, India</li>
  								<li>Visakhapatnam Steel Plant, Andhra Pradesh , India</li>
  								<li>Visakhapatnam Steel Plant, Andhra Pradesh , India</li>
  								<li>Brooke Bond India Pvt Ltd, Ghatkeswar, Hyderabad, India</li>
  								<li>National Diary Development Board, Hyderabad, India</li>
  								</ul>
  							</div>
  						</div>
  						<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>Project Executed under the Consultant So Far :</strong>
  							<div style='color: white; padding:15px;'>
  								<ul type='round' style='list-style: circle; '>
  								<li>Engineers India Limited, Delhi</li>
  								<li>MECON Limited, Ranchi</li>
  								<li>MN Dastur, Kolkata</li>
  								</ul>
  							</div>
  						</div>
  						<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>Project Executed:  </strong>
  							<div>
  								<br> Process Plant :
  									<div style='color: white; padding:15px;'>
  									<ul type='round' style='list-style: circle; '>
  										<li>Effluent Treatment Plant with implementation of VOC System in OIL Refinery of Indian Oil</li>
  										<li>VCM Incenaration Plant With Chlorine Recovery in Petrochemical</li>
  										<li>Ammonium Sulphate Plant in Coke Oven Battery of Steel Plant</li>
  										<li>Final Gas Cooling Plant in Coke Oven Battery of Steel Plant</li>
  									</ul>
  									</div>
  							</div>
  						</div>
  						<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong> Plant Utilities & Storage :</strong>
  							<div style='color: white; padding:15px;'>
  								<ul type='round' style='list-style: circle; '>
  								<li>Floating Roof Storage Tank with allied Piping in OIL Refinery of Indian Oil</li>
  								<li>Cone Roof Edible Oil Storage Tank</li>
  								<li>Fire Fighting System, Fire Alarm System and Plant Communication in Oil Refinery</li>
  								<li>Interplant Cooling Water Piping for Power Plant</li>
  								</ul>
  							</div>
  						</div>
  						<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>Air Pollution & Others :</strong>
  							<div style='color: white; padding:15px;'>
  								<ul type='round' style='list-style: circle; '>
  								<li>Electrostatic Precepitator for Cast House of Blast Furnace in Steel Plant</li>
  								<li>Dryer ESP for Copper Smelter Plant</li>
  								<li>Furnace ESP for Copper Smelter Plant</li>
  								<li>Hot Air Generator for Food, Paper and Cement Industry</li>
  								</ul>
  							</div>
  						</div>
  						<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>Functional Area:</strong>
  							<div style='color: white; padding:15px;'>
  								<ul type='round' style='list-style: circle; '>
  								<li>Contract Scope identification and Kick-off</li>
  								<li>Planning Package Finalisation and in house approval of Project Execution Budget.</li>
  								<li>Billing Schedule Finalisation and Cashlflow Projection </li>
  								<li>Client / consultant co-ordination including attending review meeting and submission of monthly Report</li>
  								<li>Co-Ordination for Drawing Approval, Ordering and material delivery</li>
  								<li>Site Co-ordination for sequential material despatch for smooth work progress</li>
  								<li>Raising of Invoice and ensure Collection of Payment</li>
  								<li>Generation of Trouble Reporting and it's preventive measure</li>
  								<li>Extra Claim generation, submission, clarification and it's realisation</li>
  								<li>Delay Analysis Record keeping and It`s submission towards LD Waiver</li>
  								<li>Project Close out Report submission for Contract Closure</li>
  						
  								</ul>
  							</div>
  						</div>
  						<div style='padding: 30px;color:#0de5fb;font-size:19px;'><strong>Type of Work &  Equipments Handled:</strong>
  							<div style='color: white; padding:15px;'>
  								<ul type='round' style='list-style: circle; '>
  								<li><strong>Civil </strong> : Water Retaining Structure, Tower, Pump House, Control Room, Sub-Station,RCC Road,Trench and Architectural Finish of Building including Floor and Roof Treatment, A/R Brick Lining.</li>
  								<li><strong>Mechanical </strong> :Large Dia Floating Roof CS Tankages, SS 316 L Tankages, Heat Exchangers, Centrifugal, Horizontal and Screw Pumps, Oil Skimmers, Clarifiers,ID Fan, Larger Dia Ducting, Duct Structure, CS,SS and Lined Piping of IBR and Non IBR with Valves </li>
  								<li><strong>Electrical </strong>  : HT Sw Gear, MCC, PMCC, PDB, Lighting Transformer, HT Transformer, Plant Illumination, Lighting and Earthing System</li>
  								<li><strong>Instrumentation </strong> :DCS, PLC, Analysers, Various measuring field Instrument, and Control Instrument.</li>
  								</ul>
  							</div>
  						</div> ",
      ],
      [
          'Section' => 'section-m6',
          'HeaderImage' => 'frontend/assets/images/courses-05.jpg',
      ...
      [
          'Section' => 'section-m7',
          'HeaderImage' => 'frontend/assets/images/courses-03.jpg',
      ...
      [
		'Section' => 'section-m9', 
	  'HeaderImage' => 'frontend/assets/images/courses-02.jpg', 
	  'HeaderName' => 'Mr Sushanta Kumar Saha', 
	  'Designation' => 'Chief Financial Advisor', 
	  'Short-Description' => 'Cost Accountancy from Cost Accountants of India). 29+ Years experience in diverse fields in Accounts and Finance.', 
	  'Description' => '<p>Cost Accountancy from Cost Accountants of India). 29+ Years experience in diverse fields in Accounts and Finance.</p>', 
	  'Extra' => ''],
  ];
  ...
  <section class="section courses management container" data-section="management" id="management">
